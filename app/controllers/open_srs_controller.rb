class OpenSrsController < ApplicationController
    ...
    def monthly_quality_grade
      ...
      @deptSWwise_updated_as_percent_of_closed_cases = @deptSWwide_mar_2020_sla_cases_closed_but_updated_later.to_f.round(2)/@deptSWwide_mar_2020_sla_due_cases.to_f.round(2)
      @deptSWwide_mar_2020_updated_grade = Sr.grade(@deptSWwise_updated_as_percent_of_closed_cases)
      @deptSWwide_mar_2020_actual_due_and_closed_cases = Sr.where(['due_date > ? AND date_closed < ?', '2020-03-04', '2020-03-31']).where(department: 'SWM Solid Waste Management', status: 'Closed', trash_quad: 'SW', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptSWwide_mar_2020_sla_percent_complete = @deptSWwide_mar_2020_actual_due_and_closed_cases.to_f.round(2)/@deptSWwide_mar_2020_sla_due_cases.to_f.round(2)
      @deptSWWide_mar_2020_grade= Sr.grade(@deptSWwide_mar_2020_sla_percent_complete)

      @deptNWwide_mar_2020_sla_cases_closed_but_updated_later = OpenSr.nwMar2020_sla_cases_closed_but_updated_later
      @deptNWwide_mar_2020_sla_due_cases = OpenSr.nwMar2020_sla_due_cases
      @deptNWwise_updated_as_percent_of_closed_cases = @deptNWwide_mar_2020_sla_cases_closed_but_updated_later.to_f.round(2)/@deptNWwide_mar_2020_sla_due_cases.to_f.round(2)
      @deptNWwide_mar_2020_updated_grade = Sr.grade(@deptNWwise_updated_as_percent_of_closed_cases)
      @deptNWwide_mar_2020_sla_due_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2020-03-01', '2020-03-31']).where(department: 'SWM Solid Waste Management', trash_quad: 'NW', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptNWwide_mar_2020_actual_due_and_closed_cases = Sr.where(['due_date > ? AND date_closed < ?', '2020-03-01', '2020-03-31']).where(department: 'SWM Solid Waste Management', status: 'Closed', trash_quad: 'NW', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptNWwide_mar_2020_sla_percent_complete = @deptNWwide_mar_2020_actual_due_and_closed_cases.to_f.round(2)/@deptNWwide_mar_2020_sla_due_cases.to_f.round(2)
      # binding.pry
      @deptNWWide_mar_2020_grade= Sr.grade(@deptNWwide_mar_2020_sla_percent_complete)
      # binding.pry

      @deptSEwide_mar_2020_sla_cases_closed_but_updated_later = OpenSr.seMar2020_sla_cases_closed_but_updated_later
      @deptSEwide_mar_2020_sla_due_cases = OpenSr.seMar2020_sla_due_cases
      @deptSEwise_updated_as_percent_of_closed_cases = @deptSEwide_mar_2020_sla_cases_closed_but_updated_later.to_f.round(2)/@deptSEwide_mar_2020_sla_due_cases.to_f.round(2)
      @deptSEwide_mar_2020_updated_grade = Sr.grade(@deptSEwise_updated_as_percent_of_closed_cases)
      @deptSEwide_mar_2020_sla_updated_cases = Sr.where(['due_date > ? AND updated_at < ?', '2020-03-01', '2020-03-31']).where(department: 'SWM Solid Waste Management', trash_quad: 'SE', sr_type: ['Missed Heavy Trash Pickup', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptSEwide_mar_2020_sla_due_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2020-03-01', '2020-03-31']).where(department: 'SWM Solid Waste Management', trash_quad: 'SE', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptSEwide_mar_2020_actual_due_and_closed_cases = Sr.where(['due_date > ? AND date_closed < ?', '2020-03-01', '2020-03-31']).where(department: 'SWM Solid Waste Management', status: 'Closed', trash_quad: 'SE', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptSEwide_mar_2020_sla_percent_complete = @deptSEwide_mar_2020_actual_due_and_closed_cases.to_f.round(2)/@deptSEwide_mar_2020_sla_due_cases.to_f.round(2)
      # binding.pry
      @deptSEWide_mar_2020_grade= Sr.grade(@deptSEwide_mar_2020_sla_percent_complete)

      @deptNEwide_mar_2020_sla_cases_closed_but_updated_later = OpenSr.neMar2020_sla_cases_closed_but_updated_later
      @deptNEwide_mar_2020_sla_due_cases = OpenSr.neMar2020_sla_due_cases
      @deptNEwise_updated_as_percent_of_closed_cases = @deptNEwide_mar_2020_sla_cases_closed_but_updated_later.to_f.round(2)/@deptNEwide_mar_2020_sla_due_cases.to_f.round(2)
      @deptNEwide_mar_2020_updated_grade = Sr.grade(@deptNEwise_updated_as_percent_of_closed_cases)
      @deptNEwide_mar_2020_sla_due_and_updated_cases = Sr.where(['sr_create_date > ? AND due_date < ?', '2020-03-01', '2020-03-31']).
      where(department: 'SWM Solid Waste Management', trash_quad: 'NE', sr_type: ['Missed Heavy Trash Pickup', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).where('updated_at > due_date').count
      @deptNEwide_mar_2020_sla_updated_cases = Sr.where(['due_date > ? AND updated_at < ?', '2020-03-01', '2020-03-31']).where(department: 'SWM Solid Waste Management', trash_quad: 'NE', sr_type: ['Missed Heavy Trash Pickup', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptNEwide_mar_2020_sla_due_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2020-03-01', '2020-03-31']).where(department: 'SWM Solid Waste Management', trash_quad: 'NE', sr_type: ['Missed Heavy Trash Pickup', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptNEwide_mar_2020_actual_due_and_closed_cases = Sr.where(['due_date > ? AND date_closed < ?', '2020-03-01', '2020-03-31']).where(department: 'SWM Solid Waste Management', status: 'Closed', trash_quad: 'NE', sr_type: ['Missed Heavy Trash Pickup', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptNEwide_mar_2020_sla_percent_complete = @deptNEwide_mar_2020_actual_due_and_closed_cases.to_f.round(2)/@deptNEwide_mar_2020_sla_due_cases.to_f.round(2)
      @deptNEWide_mar_2020_grade= Sr.grade(@deptNEwide_mar_2020_sla_percent_complete)

      @deptSWwide_feb_2020_sla_updated_cases = Sr.where(['due_date > ? AND updated_at < ?', '2020-02-01', '2020-02-29']).where(department: 'SWM Solid Waste Management', trash_quad: 'SW', sr_type: ['Missed Heavy Trash Pickup', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptSWwide_feb_2020_sla_due_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2020-02-01', '2020-02-29']).where(department: 'SWM Solid Waste Management', trash_quad: 'SW', sr_type: ['Missed Heavy Trash Pickup', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptSWwide_feb_2020_actual_due_and_closed_cases = Sr.where(['due_date > ? AND date_closed < ?', '2020-02-01', '2020-02-29']).where(department: 'SWM Solid Waste Management', status: 'Closed', trash_quad: 'SW', sr_type: ['Missed Heavy Trash Pickup', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      ...
      @deptSWWide_feb_2020_grade= Sr.grade(@deptSWwide_feb_2020_sla_percent_complete)

      @deptNWwide_feb_2020_sla_due_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2020-02-01', '2020-02-29']).where(department: 'SWM Solid Waste Management', trash_quad: 'NW', sr_type: ['Missed Heavy Trash Pickup', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptNWwide_feb_2020_actual_due_and_closed_cases = Sr.where(['due_date > ? AND date_closed < ?', '2020-02-01', '2020-02-29']).where(department: 'SWM Solid Waste Management', status: 'Closed', trash_quad: 'NW', sr_type: ['Missed Heavy Trash Pickup', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptNWwide_feb_2020_sla_percent_complete = @deptNWwide_feb_2020_actual_due_and_closed_cases.to_f.round(2)/@deptNWwide_feb_2020_sla_due_cases.to_f.round(2)
      @deptNWWide_feb_2020_grade= Sr.grade(@deptNWwide_feb_2020_sla_percent_complete)

      @deptSEwide_feb_2020_sla_due_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2020-02-01', '2020-02-29']).where(department: 'SWM Solid Waste Management', trash_quad: 'SE', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptSEwide_feb_2020_actual_due_and_closed_cases = Sr.where(['due_date > ? AND date_closed < ?', '2020-02-01', '2020-02-29']).where(department: 'SWM Solid Waste Management', status: 'Closed', trash_quad: 'SE', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptSEwide_feb_2020_sla_percent_complete = @deptSEwide_feb_2020_actual_due_and_closed_cases.to_f.round(2)/@deptSEwide_feb_2020_sla_due_cases.to_f.round(2)
      @deptSEWide_feb_2020_grade= Sr.grade(@deptSEwide_feb_2020_sla_percent_complete)

      @deptNEwide_feb_2020_sla_due_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2020-02-01', '2020-02-29']).where(department: 'SWM Solid Waste Management', trash_quad: 'NE', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptNEwide_feb_2020_actual_due_and_closed_cases = Sr.where(['due_date > ? AND date_closed < ?', '2020-02-01', '2020-02-29']).where(department: 'SWM Solid Waste Management', status: 'Closed', trash_quad: 'NE', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptNEwide_feb_2020_sla_percent_complete = @deptNEwide_feb_2020_actual_due_and_closed_cases.to_f.round(2)/@deptNEwide_feb_2020_sla_due_cases.to_f.round(2)
      @deptNEWide_feb_2020_grade= Sr.grade(@deptNEwide_feb_2020_sla_percent_complete)

      @deptSWwide_jan_2020_sla_updated_cases = Sr.where(['due_date > ? AND updated_at < ?', '2020-01-01', '2020-01-31']).where(department: 'SWM Solid Waste Management', trash_quad: 'SW', sr_type: ['Missed Heavy Trash Pickup
    ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptSWwide_jan_2020_sla_due_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2020-01-01', '2020-01-31']).where(department: 'SWM Solid Waste Management', trash_quad: 'SW', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptSWwide_jan_2020_actual_due_and_closed_cases = Sr.where(['due_date > ? AND date_closed < ?', '2020-01-01', '2020-01-31']).where(department: 'SWM Solid Waste Management', status: 'Closed', trash_quad: 'SW', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptSWwide_jan_2020_sla_percent_complete = @deptSWwide_jan_2020_actual_due_and_closed_cases.to_f.round(2)/@deptSWwide_jan_2020_sla_due_cases.to_f.round(2)
      @deptSWWide_jan_2020_grade= Sr.grade(@deptSWwide_jan_2020_sla_percent_complete)

      @deptNWwide_jan_2020_sla_due_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2020-01-01', '2020-01-31']).where(department: 'SWM Solid Waste Management', trash_quad: 'NW', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptNWwide_jan_2020_actual_due_and_closed_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2020-01-01', '2020-01-31']).where(department: 'SWM Solid Waste Management', status: 'Closed', trash_quad: 'NW', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptNWwide_jan_2020_sla_percent_complete = @deptNWwide_jan_2020_actual_due_and_closed_cases.to_f.round(2)/@deptNWwide_jan_2020_sla_due_cases.to_f.round(2)
      @deptNWWide_jan_2020_grade= Sr.grade(@deptNWwide_jan_2020_sla_percent_complete)

      @deptSEwide_jan_2020_sla_due_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2020-01-01', '2020-01-31']).where(department: 'SWM Solid Waste Management', trash_quad: 'SE', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptSEwide_jan_2020_actual_due_and_closed_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2020-01-01', '2020-01-31']).where(department: 'SWM Solid Waste Management', status: 'Closed', trash_quad: 'SE', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptSEwide_jan_2020_sla_percent_complete = @deptSEwide_jan_2020_actual_due_and_closed_cases.to_f.round(2)/@deptSEwide_jan_2020_sla_due_cases.to_f.round(2)
      @deptSEWide_jan_2020_grade= Sr.grade(@deptSEwide_jan_2020_sla_percent_complete)

      @deptNEwide_jan_2020_sla_due_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2020-01-01', '2020-01-31']).where(department: 'SWM Solid Waste Management', trash_quad: 'NE', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptNEwide_jan_2020_actual_due_and_closed_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2020-01-01', '2020-01-31']).where(department: 'SWM Solid Waste Management', status: 'Closed', trash_quad: 'NE', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptNEwide_jan_2020_sla_percent_complete = @deptNEwide_jan_2020_actual_due_and_closed_cases.to_f.round(2)/@deptNEwide_jan_2020_sla_due_cases.to_f.round(2)
      @deptNEWide_jan_2020_grade= Sr.grade(@deptNEwide_jan_2020_sla_percent_complete)

      @deptSWwide_dec_2020_sla_updated_cases = Sr.where(['due_date > ? AND updated_at < ?', '2019-12-01', '2019-12-31']).
      where(department: 'SWM Solid Waste Management', trash_quad: 'SW', sr_type: ['Missed Heavy Trash Pickup', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptSWwide_dec_2019_sla_due_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2019-12-01', '2019-12-31']).where(department: 'SWM Solid Waste Management', trash_quad: 'SW', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptSWwide_dec_2019_actual_due_and_closed_cases = Sr.where(['due_date > ? AND date_closed < ?', '2019-12-01', '2019-12-31']).where(department: 'SWM Solid Waste Management', status: 'Closed', trash_quad: 'SW', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      ...
      @deptSWWide_dec_2019_grade= Sr.grade(@deptSWwide_dec_2019_sla_percent_complete)

      @deptNWwide_dec_2019_sla_due_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2019-12-01', '2019-12-31']).where(department: 'SWM Solid Waste Management', trash_quad: 'NW', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptNWwide_dec_2019_actual_due_and_closed_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2019-12-01', '2019-12-31']).where(department: 'SWM Solid Waste Management', status: 'Closed', trash_quad: 'NW', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptNWwide_dec_2019_sla_percent_complete = @deptNWwide_dec_2019_actual_due_and_closed_cases.to_f.round(2)/@deptNWwide_dec_2019_sla_due_cases.to_f.round(2)
      @deptNWWide_dec_2019_grade= Sr.grade(@deptNWwide_dec_2019_sla_percent_complete)

      @deptSEwide_dec_2019_sla_due_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2019-12-01', '2019-12-31']).where(department: 'SWM Solid Waste Management', trash_quad: 'SE', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptSEwide_dec_2019_actual_due_and_closed_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2019-12-01', '2019-12-31']).where(department: 'SWM Solid Waste Management', status: 'Closed', trash_quad: 'SE', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptSEwide_dec_2019_sla_percent_complete = @deptSEwide_dec_2019_actual_due_and_closed_cases.to_f.round(2)/@deptSEwide_dec_2019_sla_due_cases.to_f.round(2)
      @deptSEWide_dec_2019_grade= Sr.grade(@deptSEwide_dec_2019_sla_percent_complete)

      @deptNEwide_dec_2019_sla_due_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2019-12-01', '2019-12-31']).where(department: 'SWM Solid Waste Management', trash_quad: 'NE', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptNEwide_dec_2019_actual_due_and_closed_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2020-01-01', '2019-12-31']).where(department: 'SWM Solid Waste Management', status: 'Closed', trash_quad: 'NE', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptNEwide_dec_2019_sla_percent_complete = @deptNEwide_dec_2019_actual_due_and_closed_cases.to_f.round(2)/@deptNEwide_dec_2019_sla_due_cases.to_f.round(2)
      @deptNEWide_dec_2019_grade= Sr.grade(@deptNEwide_dec_2019_sla_percent_complete)

      @deptSWwide_nov_2019_sla_due_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2019-11-01', '2019-11-30']).where(department: 'SWM Solid Waste Management', trash_quad: 'SW', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptSWwide_nov_2019_actual_due_and_closed_cases = Sr.where(['due_date > ? AND date_closed < ?', '2019-11-01', '2019-11-30']).where(department: 'SWM Solid Waste Management', status: 'Closed', trash_quad: 'SW', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptSWwide_nov_2019_sla_percent_complete = @deptSWwide_nov_2019_actual_due_and_closed_cases.to_f.round(2)/@deptSWwide_nov_2019_sla_due_cases.to_f.round(2)
      @deptSWWide_nov_2019_grade= Sr.grade(@deptSWwide_nov_2019_sla_percent_complete)

      @deptNWwide_nov_2019_sla_due_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2019-11-01', '2019-11-30']).where(department: 'SWM Solid Waste Management', trash_quad: 'NW', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptNWwide_nov_2019_actual_due_and_closed_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2019-11-01', '2019-11-30']).where(department: 'SWM Solid Waste Management', status: 'Closed', trash_quad: 'NW', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptNWwide_nov_2019_sla_percent_complete = @deptNWwide_nov_2019_actual_due_and_closed_cases.to_f.round(2)/@deptNWwide_nov_2019_sla_due_cases.to_f.round(2)
      @deptNWWide_nov_2019_grade= Sr.grade(@deptNWwide_nov_2019_sla_percent_complete)

      @deptSEwide_nov_2019_sla_due_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2019-11-01', '2019-11-30']).where(department: 'SWM Solid Waste Management', trash_quad: 'SE', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptSEwide_nov_2019_actual_due_and_closed_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2019-11-01', '2019-11-30']).where(department: 'SWM Solid Waste Management', status: 'Closed', trash_quad: 'SE', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptSEwide_nov_2019_sla_percent_complete = @deptSEwide_nov_2019_actual_due_and_closed_cases.to_f.round(2)/@deptSEwide_nov_2019_sla_due_cases.to_f.round(2)
      @deptSEWide_nov_2019_grade= Sr.grade(@deptSEwide_nov_2019_sla_percent_complete)

      @deptNEwide_nov_2019_sla_due_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2019-11-01', '2019-11-30']).where(department: 'SWM Solid Waste Management', trash_quad: 'NE', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptNEwide_nov_2019_actual_due_and_closed_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2019-11-01', '2019-11-30']).where(department: 'SWM Solid Waste Management', status: 'Closed', trash_quad: 'NE', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptNEwide_nov_2019_sla_percent_complete = @deptNEwide_nov_2019_actual_due_and_closed_cases.to_f.round(2)/@deptNEwide_nov_2019_sla_due_cases.to_f.round(2)
      @deptNEWide_nov_2019_grade= Sr.grade(@deptNEwide_nov_2019_sla_percent_complete)

      @deptSWwide_oct_2019_sla_due_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2019-10-01', '2019-10-31']).where(department: 'SWM Solid Waste Management', trash_quad: 'SW', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptSWwide_oct_2019_actual_due_and_closed_cases = Sr.where(['due_date > ? AND date_closed < ?', '2019-10-01', '2019-10-31']).where(department: 'SWM Solid Waste Management', status: 'Closed', trash_quad: 'SW', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptSWwide_oct_2019_sla_percent_complete = @deptSWwide_oct_2019_actual_due_and_closed_cases.to_f.round(2)/@deptSWwide_oct_2019_sla_due_cases.to_f.round(2)
      @deptSWWide_oct_2019_grade= Sr.grade(@deptSWwide_oct_2019_sla_percent_complete)

      @deptNWwide_oct_2019_sla_due_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2019-10-01', '2019-10-31']).where(department: 'SWM Solid Waste Management', trash_quad: 'NW', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptNWwide_oct_2019_actual_due_and_closed_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2019-10-01', '2019-10-31']).where(department: 'SWM Solid Waste Management', status: 'Closed', trash_quad: 'NW', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptNWwide_oct_2019_sla_percent_complete = @deptNWwide_oct_2019_actual_due_and_closed_cases.to_f.round(2)/@deptNWwide_oct_2019_sla_due_cases.to_f.round(2)
      @deptNWWide_oct_2019_grade= Sr.grade(@deptNWwide_oct_2019_sla_percent_complete)

      @deptSEwide_oct_2019_sla_due_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2019-10-01', '2019-10-31']).where(department: 'SWM Solid Waste Management', trash_quad: 'SE', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptSEwide_oct_2019_actual_due_and_closed_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2019-10-01', '2019-10-31']).where(department: 'SWM Solid Waste Management', status: 'Closed', trash_quad: 'SE', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptSEwide_oct_2019_sla_percent_complete = @deptSEwide_oct_2019_actual_due_and_closed_cases.to_f.round(2)/@deptSEwide_oct_2019_sla_due_cases.to_f.round(2)
      @deptSEWide_oct_2019_grade= Sr.grade(@deptSEwide_oct_2019_sla_percent_complete)

      @deptNEwide_oct_2019_sla_due_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2019-10-01', '2019-10-31']).where(department: 'SWM Solid Waste Management', trash_quad: 'NE', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptNEwide_oct_2019_actual_due_and_closed_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2019-10-01', '2019-10-31']).where(department: 'SWM Solid Waste Management', status: 'Closed', trash_quad: 'NE', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptNEwide_oct_2019_sla_percent_complete = @deptNEwide_oct_2019_actual_due_and_closed_cases.to_f.round(2)/@deptNEwide_oct_2019_sla_due_cases.to_f.round(2)
      @deptNEWide_oct_2019_grade= Sr.grade(@deptNEwide_oct_2019_sla_percent_complete)

      @deptSWwide_sept_2019_sla_due_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2019-09-01', '2019-09-30']).where(department: 'SWM Solid Waste Management', trash_quad: 'SW', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptSWwide_sept_2019_actual_due_and_closed_cases = Sr.where(['due_date > ? AND date_closed < ?', '2019-09-01', '2019-09-30']).where(department: 'SWM Solid Waste Management', status: 'Closed', trash_quad: 'SW', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptSWwide_sept_2019_sla_percent_complete = @deptSWwide_sept_2019_actual_due_and_closed_cases.to_f.round(2)/@deptSWwide_sept_2019_sla_due_cases.to_f.round(2)
      @deptSWWide_sept_2019_grade= Sr.grade(@deptSWwide_sept_2019_sla_percent_complete)

      @deptNWwide_sept_2019_sla_due_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2019-09-01', '2019-09-30']).where(department: 'SWM Solid Waste Management', trash_quad: 'NW', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptNWwide_sept_2019_actual_due_and_closed_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2019-09-01', '2019-09-30']).where(department: 'SWM Solid Waste Management', status: 'Closed', trash_quad: 'NW', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptNWwide_sept_2019_sla_percent_complete = @deptNWwide_sept_2019_actual_due_and_closed_cases.to_f.round(2)/@deptNWwide_sept_2019_sla_due_cases.to_f.round(2)
      @deptNWWide_sept_2019_grade= Sr.grade(@deptNWwide_sept_2019_sla_percent_complete)

      @deptSEwide_sept_2019_sla_due_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2019-09-01', '2019-09-30']).where(department: 'SWM Solid Waste Management', trash_quad: 'SE', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptSEwide_sept_2019_actual_due_and_closed_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2019-09-01', '2019-09-30']).where(department: 'SWM Solid Waste Management', status: 'Closed', trash_quad: 'SE', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptSEwide_sept_2019_sla_percent_complete = @deptSEwide_sept_2019_actual_due_and_closed_cases.to_f.round(2)/@deptSEwide_sept_2019_sla_due_cases.to_f.round(2)
      @deptSEWide_sept_2019_grade= Sr.grade(@deptSEwide_sept_2019_sla_percent_complete)

      @deptNEwide_sept_2019_sla_due_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2019-09-01', '2019-09-30']).where(department: 'SWM Solid Waste Management', trash_quad: 'NE', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptNEwide_sept_2019_actual_due_and_closed_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2019-09-01', '2019-09-30']).where(department: 'SWM Solid Waste Management', status: 'Closed', trash_quad: 'NE', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptNEwide_sept_2019_sla_percent_complete = @deptNEwide_sept_2019_actual_due_and_closed_cases.to_f.round(2)/@deptNEwide_sept_2019_sla_due_cases.to_f.round(2)
      @deptNEWide_sept_2019_grade= Sr.grade(@deptNEwide_sept_2019_sla_percent_complete)

      @deptSWwide_aug_2019_sla_due_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2019-08-01', '2019-08-31']).where(department: 'SWM Solid Waste Management', trash_quad: 'SW', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptSWwide_aug_2019_actual_due_and_closed_cases = Sr.where(['due_date > ? AND date_closed < ?', '2019-08-01', '2019-08-31']).where(department: 'SWM Solid Waste Management', status: 'Closed', trash_quad: 'SW', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      ...
      @deptSWWide_aug_2019_grade= Sr.grade(@deptSWwide_aug_2019_sla_percent_complete)

      @deptNWwide_aug_2019_sla_due_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2019-08-01', '2019-08-31']).where(department: 'SWM Solid Waste Management', trash_quad: 'NW', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptNWwide_aug_2019_actual_due_and_closed_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2019-08-01', '2019-08-31']).where(department: 'SWM Solid Waste Management', status: 'Closed', trash_quad: 'NW', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      ...
      @deptNWWide_aug_2019_grade= Sr.grade(@deptNWwide_aug_2019_sla_percent_complete)

      @deptSEwide_aug_2019_sla_due_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2019-08-01', '2019-08-31']).where(department: 'SWM Solid Waste Management', trash_quad: 'SE', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptSEwide_aug_2019_actual_due_and_closed_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2019-08-01', '2019-08-31']).where(department: 'SWM Solid Waste Management', status: 'Closed', trash_quad: 'SE', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      ...
      @deptSEWide_aug_2019_grade= Sr.grade(@deptSEwide_aug_2019_sla_percent_complete)

      @deptNEwide_aug_2019_sla_due_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2019-08-01', '2019-08-31']).where(department: 'SWM Solid Waste Management', trash_quad: 'NE', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      @deptNEwide_aug_2019_actual_due_and_closed_cases = Sr.where(['sr_create_date > ? AND date_closed < ?', '2019-08-01', '2019-08-31']).where(department: 'SWM Solid Waste Management', status: 'Closed', trash_quad: 'NE', sr_type: ['Missed Heavy Trash Pickup
  ', 'Container Problem', 'New Resident Container', 'Recycling Participation NEW', 'Recycling Cart Repair or Replace', 'SWM Escalation', 'Missed Garbage Pickup', 'Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection',  'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint', 'Physically Challenged Pickup']).count
      ...
      @deptNEWide_aug_2019_grade= Sr.grade(@deptNEwide_aug_2019_sla_percent_complete)
    end
    def summary1
    ...
    @missedRecNewSWTotal = Sr.where(trash_quad: 'SW',sr_type:'Recycling Participation NEW', expression:['Overdue','Not Overdue']).count
    @missedRecNewSWOverdue = Sr.where(trash_quad: 'SW',sr_type:'Recycling Participation NEW', expression:['Overdue']).count
    @missedRecNewSWPercentOverdue = "#{((@missedRecNewSWOverdue.to_f.round(2)/@missedRecNewSWTotal.to_f.round(2))*100).round(2)}%"
    @missedRecNewSWPercentNotOverdue = "#{((1-(@missedRecNewSWOverdue.to_f.round(2)/@missedRecNewSWTotal.to_f.round(2)))*100).round(2)}%"
    @missedRecNewSWNotOverdue = Sr.where(trash_quad: 'SW',sr_type:'Recycling Participation NEW', expression:['Not Overdue']).count
    @missedRecNewOverdueDigits = @missedRecNewSWNotOverdue.to_f/@missedRecNewSWTotal.to_f
    @missedRecNewSWGrade= OpenSr.qualityGrade(@missedRecNewOverdueDigits)

    @missedRecCarRepSWTotal = Sr.where(trash_quad: 'SW',sr_type:'Recycling Cart Repair or Replace', expression:['Overdue','Not Overdue']).count
    @missedRecCarRepSWOverdue = Sr.where(trash_quad: 'SW',sr_type:'Recycling Cart Repair or Replace', expression:['Overdue']).count
    @missedRecCarRepSWPercentOverdue = "#{((@missedRecCarRepSWOverdue.to_f.round(2)/@missedRecCarRepSWTotal.to_f.round(2))*100).round(2)}%"
    @missedRecCarRepSWPercentNotOverdue = "#{((1-(@missedRecCarRepSWOverdue.to_f.round(2)/@missedRecCarRepSWTotal.to_f.round(2)))*100).round(2)}%"
    @missedRecCarRepSWNotOverdue = Sr.where(trash_quad: 'SW',sr_type:'Recycling Cart Repair or Replace', expression:['Not Overdue']).count
    @missedRecCarRepSWOverdueDigits = @missedRecCarRepSWNotOverdue.to_f/@missedRecCarRepSWTotal.to_f
    @missedRecCarRepSWGrade= OpenSr.qualityGrade(@missedRecCarRepSWOverdueDigits)

    @missedSWMEscaSWTotal = Sr.where(trash_quad: 'SW',sr_type:'SWM Escalation', expression:['Overdue','Not Overdue']).count
    @missedSWMEscaSWOverdue = Sr.where(trash_quad: 'SW',sr_type:'SWM Escalation', expression:['Overdue']).count
    @missedSWMEscaSWPercentOverdue = "#{((@missedSWMEscaSWOverdue.to_f.round(2)/@missedSWMEscaSWTotal.to_f.round(2))*100).round(2)}%"
    @missedSWMEscaSWPercentNotOverdue = "#{((1-(@missedSWMEscaSWOverdue.to_f.round(2)/@missedSWMEscaSWTotal.to_f.round(2)))*100).round(2)}%"
    @missedSWMEscaSWNotOverdue = Sr.where(trash_quad: 'SW',sr_type:'SWM Escalation', expression:['Not Overdue']).count
    @missedSWMEscaSWOverdueDigits = @missedSWMEscaSWNotOverdue.to_f/@missedSWMEscaSWTotal.to_f
    @missedSWMEscaSWGrade= OpenSr.qualityGrade(@missedSWMEscaSWOverdueDigits)

    @missedMisGarbSWTotal = Sr.where(trash_quad: 'SW',sr_type:'Missed Garbage Pickup', expression:['Overdue','Not Overdue']).count
    @missedMisGarbSWOverdue = Sr.where(trash_quad: 'SW',sr_type:'Missed Garbage Pickup', expression:['Overdue']).count
    @missedMisGarbSWPercentOverdue = "#{((@missedMisGarbSWOverdue.to_f.round(2)/@missedMisGarbSWTotal.to_f.round(2))*100).round(2)}%"
    @missedMisGarbSWPercentNotOverdue = "#{((1-(@missedMisGarbSWOverdue.to_f.round(2)/@missedMisGarbSWTotal.to_f.round(2)))*100).round(2)}%"
    @missedMisGarbSWNotOverdue = Sr.where(trash_quad: 'SW',sr_type:'Missed Garbage Pickup', expression:['Not Overdue']).count
    @missedMisGarbSWOverdueDigits = @missedMisGarbSWNotOverdue.to_f/@missedMisGarbSWTotal.to_f
    @missedMisGarbSWGrade= OpenSr.qualityGrade(@missedMisGarbSWOverdueDigits)

    @missedTrashDumpSWTotal = Sr.where(trash_quad: 'SW',sr_type:'Trash Dumping or Illegal Dumpsite', expression:['Overdue','Not Overdue']).count
    @missedMTrashDumpSWOverdue = Sr.where(trash_quad: 'SW',sr_type:'Trash Dumping or Illegal Dumpsite', expression:['Overdue']).count
    @missedTrashDumpSWPercentOverdue = "#{((@missedTrashDumpSWOverdue.to_f.round(2)/@missedTrashDumpSWTotal.to_f.round(2))*100).round(2)}%"
    @missedMTrashDumpSWNotOverdue = Sr.where(trash_quad: 'SW',sr_type:'Trash Dumping or Illegal Dumpsite', expression:['Not Overdue']).count
    @missedTrashDumpSWPercentNotOverdue = "#{((@missedMTrashDumpSWNotOverdue.to_f.round(2)/@missedTrashDumpSWTotal.to_f.round(2))*100).round(2)}%"
    @missedTrashDumpSWNotOverdue = Sr.where(trash_quad: 'SW',sr_type:'Trash Dumping or Illegal Dumpsite', expression:['Not Overdue']).count
    @missedTrashDumpSWOverdueDigits = @missedTrashDumpSWNotOverdue.to_f/@missedTrashDumpSWTotal.to_f
    @missedTrashDumpSWGrade= OpenSr.qualityGrade(@missedTrashDumpSWOverdueDigits)

    @missedAddACanSWTotal = Sr.where(trash_quad: 'SW',sr_type:'Add A Can', expression:['Overdue','Not Overdue']).count
    @missedAddACanSWOverdue = Sr.where(trash_quad: 'SW',sr_type:'Add A Can', expression:['Overdue']).count
    @missedAddACanSWPercentOverdue = "#{((@missedAddACanSWOverdue.to_f.round(2)/@missedAddACanSWTotal.to_f.round(2))*100).round(2)}%"
    @missedAddACanSWNotOverdue = Sr.where(trash_quad: 'SW',sr_type:'Add A Can', expression:['Not Overdue']).count
    @missedAddACanSWPercentNotOverdue = "#{((@missedAddACanSWNotOverdue.to_f.round(2)/@missedAddACanSWTotal.to_f.round(2))*100).round(2)}%"
    @missedAddACanSWNotOverdue = Sr.where(trash_quad: 'SW',sr_type:'Add A Can', expression:['Not Overdue']).count
    @missedAddACanSWOverdueDigits = @missedAddACanSWNotOverdue.to_f/@missedAddACanSWTotal.to_f
    @missedAddACanSWGrade= OpenSr.qualityGrade(@missedAddACanSWOverdueDigits)

    @missedStormDebSWTotal = Sr.where(trash_quad: 'SW',sr_type:'Storm Debris Collection', expression:['Overdue','Not Overdue']).count
    @missedStormDebSWOverdue = Sr.where(trash_quad: 'SW',sr_type:'Storm Debris Collection', expression:['Overdue']).count
    @missedStormDebSWPercentOverdue = "#{((@missedStormDebSWOverdue.to_f.round(2)/@missedStormDebSWTotal.to_f.round(2))*100).round(2)}%"
    @missedStormDebSWNotOverdue = Sr.where(trash_quad: 'SW',sr_type:'Storm Debris Collection', expression:['Not Overdue']).count
    @missedStormDebSWPercentNotOverdue = "#{((@missedStormDebSWNotOverdue.to_f.round(2)/@missedStormDebSWTotal.to_f.round(2))*100).round(2)}%"
    @missedStormDebSWNotOverdue = Sr.where(trash_quad: 'SW',sr_type:'Storm Debris Collection', expression:['Not Overdue']).count
    @missedStormDebSWOverdueDigits = @missedStormDebSWNotOverdue.to_f/@missedStormDebSWTotal.to_f
    @missedStormDebSWGrade= OpenSr.qualityGrade(@missedStormDebSWOverdueDigits)

    @missedDeadAniColSWTotal = Sr.where(trash_quad: 'SW',sr_type:'Dead Animal Collection', expression:['Overdue','Not Overdue']).count
    @missedDeadAniColSWOverdue = Sr.where(trash_quad: 'SW',sr_type:'Dead Animal Collection', expression:['Overdue']).count
    @missedDeadAniColSWPercentOverdue = "#{((@missedDeadAniColSWOverdue.to_f.round(2)/@missedDeadAniColSWTotal.to_f.round(2))*100).round(2)}%"
    @missedDeadAniColSWNotOverdue = Sr.where(trash_quad: 'SW',sr_type:'Dead Animal Collection', expression:['Not Overdue']).count
    @missedDeadAniColSWPercentNotOverdue = "#{((@missedDeadAniColSWNotOverdue.to_f.round(2)/@missedDeadAniColSWTotal.to_f.round(2))*100).round(2)}%"
    @missedDeadAniColSWNotOverdue = Sr.where(trash_quad: 'SW',sr_type:'Dead Animal Collection', expression:['Not Overdue']).count
    @missedDeadAniColSWOverdueDigits = @missedDeadAniColSWNotOverdue.to_f/@missedDeadAniColSWTotal.to_f
    @missedDeadAniColSWGrade= OpenSr.qualityGrade(@missedDeadAniColSWOverdueDigits)

    @missedAddACanCancelSWTotal = Sr.where(trash_quad: 'SW',sr_type:'Add A Can CANCELLATION', expression:['Overdue','Not Overdue']).count
    @missedAddACanCancelSWOverdue = Sr.where(trash_quad: 'SW',sr_type:'Add A Can CANCELLATION', expression:['Overdue']).count
    @missedAddACanCancelSWPercentOverdue = "#{((@missedAddACanCancelSWOverdue.to_f.round(2)/@missedAddACanCancelSWTotal.to_f.round(2))*100).round(2)}%"
    @missedAddACanCancelSWNotOverdue = Sr.where(trash_quad: 'SW',sr_type:'Add A Can CANCELLATION', expression:['Not Overdue']).count
    @missedAddACanCancelSWPercentNotOverdue = "#{((@missedAddACanCancelSWNotOverdue.to_f.round(2)/@missedAddACanCancelSWTotal.to_f.round(2))*100).round(2)}%"
    @missedAddACanCancelSWNotOverdue = Sr.where(trash_quad: 'SW',sr_type:'Add A Can CANCELLATION', expression:['Not Overdue']).count
    @missedAddACanCancelSWOverdueDigits = @missedAddACanCancelSWNotOverdue.to_f/@missedAddACanCancelSWTotal.to_f
    @missedAddACanCancelSWGrade= OpenSr.qualityGrade(@missedAddACanCancelSWOverdueDigits)

    @missedMisRecPicUpSWTotal = Sr.where(trash_quad: 'SW',sr_type:'Missed Recycling Pickup', expression:['Overdue','Not Overdue']).count
    @missedMisRecPicUpSWOverdue = Sr.where(trash_quad: 'SW',sr_type:'Missed Recycling Pickup', expression:['Overdue']).count
    @missedMisRecPicUpSWPercentOverdue = "#{((@missedMisRecPicUpSWOverdue.to_f.round(2)/@missedMisRecPicUpSWTotal.to_f.round(2))*100).round(2)}%"
    ...
    @SWQuadSrNotOverdue = Sr.where(status:'Open',  expression:'Not Overdue', trash_quad: 'SW', sr_type: ['Missed Heavy Trash Pickup','Container Problem','New Resident Container','Recycling Participation NEW' ,'Recycling Cart Repair or Replace','SWM Escalation','Missed Garbage Pickup','Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection', 'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint','Physically Challenged Pickup']).count
...
#SE QUAD
    ...
    @missedConProbSETotal = Sr.where(trash_quad: 'SE',sr_type:'Container Problem', expression:['Overdue','Not Overdue']).count
    @missedConProbSEOverdue = Sr.where(trash_quad: 'SE',sr_type:'Container Problem', expression:['Overdue']).count
    @missedConProbSEPercentOverdue = "#{((@missedConProbSEOverdue.to_f.round(2)/@missedConProbSETotal.to_f.round(2))*100).round(2)}%"
    @missedConProbSEPercentNotOverdue = "#{((1-(@missedConProbSEOverdue.to_f.round(2)/@missedConProbSETotal.to_f.round(2)))*100).round(2)}%"
    @missedConProbSENotOverdue = Sr.where(trash_quad: 'SE',sr_type:'Container Problem', expression:['Not Overdue']).count
    ...
    @missedNewResSETotal = Sr.where(trash_quad: 'SE',sr_type:'New Resident Container', expression:['Overdue','Not Overdue']).count
    @missedNewResSEOverdue = Sr.where(trash_quad: 'SE',sr_type:'New Resident Container', expression:['Overdue']).count
    @missedNewResSEPercentOverdue = "#{((@missedNewResSEOverdue.to_f.round(2)/@missedNewResSETotal.to_f.round(2))*100).round(2)}%"
    @missedNewResSENotOverdue = Sr.where(trash_quad: 'SE',sr_type:'Container Problem', expression:['Not Overdue']).count
    ...
    @missedNewResSENotOverdue = Sr.where(trash_quad: 'SE',sr_type:'New Resident Container', expression:['Not Overdue']).count
    @missedNewResSEOverdueDigits = @missedNewResSENotOverdue.to_f/@missedNewResSWTotal.to_f
    @missedNewResSEGrade= OpenSr.qualityGrade(@missedNewResSEOverdueDigits)

    @missedRecNewSETotal = Sr.where(trash_quad: 'SE',sr_type:'Recycling Participation NEW', expression:['Overdue','Not Overdue']).count
    @missedRecNewSEOverdue = Sr.where(trash_quad: 'SE',sr_type:'Recycling Participation NEW', expression:['Overdue']).count
    @missedRecNewSEPercentOverdue = "#{((@missedRecNewSEOverdue.to_f.round(2)/@missedRecNewSETotal.to_f.round(2))*100).round(2)}%"
    @missedRecNewSEPercentNotOverdue = "#{((1-(@missedRecNewSEOverdue.to_f.round(2)/@missedRecNewSETotal.to_f.round(2)))*100).round(2)}%"
    @missedRecNewSENotOverdue = Sr.where(trash_quad: 'SE',sr_type:'Recycling Participation NEW', expression:['Not Overdue']).count
    @missedRecNewSEOverdueDigits = @missedRecNewSENotOverdue.to_f/@missedRecNewSETotal.to_f
    @missedRecNewSEGrade= OpenSr.qualityGrade(@missedRecNewSEOverdueDigits)

    @missedRecCarRepSETotal = Sr.where(trash_quad: 'SE',sr_type:'Recycling Cart Repair or Replace', expression:['Overdue','Not Overdue']).count
    @missedRecCarRepSEOverdue = Sr.where(trash_quad: 'SE',sr_type:'Recycling Cart Repair or Replace', expression:['Overdue']).count
    @missedRecCarRepSEPercentOverdue = "#{((@missedRecCarRepSEOverdue.to_f.round(2)/@missedRecCarRepSETotal.to_f.round(2))*100).round(2)}%"
    @missedRecCarRepSEPercentNotOverdue = "#{((1-(@missedRecCarRepSEOverdue.to_f.round(2)/@missedRecCarRepSETotal.to_f.round(2)))*100).round(2)}%"
    @missedRecCarRepSENotOverdue = Sr.where(trash_quad: 'SE',sr_type:'Recycling Cart Repair or Replace', expression:['Not Overdue']).count
    ...
    @missedMTrashDumpSEOverdue = Sr.where(trash_quad: 'SE',sr_type:'Trash Dumping or Illegal Dumpsite', expression:['Overdue']).count
    @missedTrashDumpSEPercentOverdue = "#{((@missedTrashDumpSEOverdue.to_f.round(2)/@missedTrashDumpSETotal.to_f.round(2))*100).round(2)}%"
    @missedMTrashDumpSENotOverdue = Sr.where(trash_quad: 'SE',sr_type:'Trash Dumping or Illegal Dumpsite', expression:['Not Overdue']).count
    @missedTrashDumpSEPercentNotOverdue = "#{((@missedMTrashDumpSENotOverdue.to_f.round(2)/@missedTrashDumpSETotal.to_f.round(2))*100).round(2)}%"
    ...
    @missedMisRecPicUpSETotal = Sr.where(trash_quad: 'SE',sr_type:'Missed Recycling Pickup', expression:['Overdue','Not Overdue']).count
    @missedMisRecPicUpSEOverdue = Sr.where(trash_quad: 'SE',sr_type:'Missed Recycling Pickup', expression:['Overdue']).count
    ...
    @missedMisRecPicUpSENotOverdue = Sr.where(trash_quad: 'SE',sr_type:'Missed Recycling Pickup', expression:['Not Overdue']).count
    ...
    @SEQuadSrTotal = Sr.where(status:'Open', expression:['Overdue', 'Not Overdue'], trash_quad: 'SE', sr_type: ['Missed Heavy Trash Pickup','Container Problem','New Resident Container','Recycling Participation NEW' ,'Recycling Cart Repair or Replace','SWM Escalation','Missed Garbage Pickup','Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection', 'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint','Physically Challenged Pickup']).count
    @SEQuadSrOverdue = Sr.where(status:'Open',  expression:'Overdue', trash_quad: 'SE', sr_type: ['Missed Heavy Trash Pickup','Container Problem','New Resident Container','Recycling Participation NEW' ,'Recycling Cart Repair or Replace','SWM Escalation','Missed Garbage Pickup','Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection', 'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint','Physically Challenged Pickup']).count
    @SEQuadPercentOverdue = "#{((@SEQuadSrOverdue.to_f/@SEQuadSrTotal.to_f)*100).round(2)}%"
    @SEQuadSrNotOverdue = Sr.where(status:'Open',  expression:'Not Overdue', trash_quad: 'SE', sr_type: ['Missed Heavy Trash Pickup','Container Problem','New Resident Container','Recycling Participation NEW' ,'Recycling Cart Repair or Replace','SWM Escalation','Missed Garbage Pickup','Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection', 'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint','Physically Challenged Pickup']).count
...
#NORTH EAST
    ...
    @missedRecCarRepNETotal = Sr.where(trash_quad: 'NE',sr_type:'Recycling Cart Repair or Replace', expression:['Overdue','Not Overdue']).count
    @missedRecCarRepNEOverdue = Sr.where(trash_quad: 'NE',sr_type:'Recycling Cart Repair or Replace', expression:['Overdue']).count
    ...
    @missedMisRecPicUpNETotal = Sr.where(trash_quad: 'NE',sr_type:'Missed Recycling Pickup', expression:['Overdue','Not Overdue']).count
    @missedMisRecPicUpNEOverdue = Sr.where(trash_quad: 'NE',sr_type:'Missed Recycling Pickup', expression:['Overdue']).count
    ...
    @missedMisRecPicUpNENotOverdue = Sr.where(trash_quad: 'NE',sr_type:'Missed Recycling Pickup', expression:['Not Overdue']).count
    ...
    @NEQuadSrTotal = Sr.where(status:'Open', expression:['Overdue', 'Not Overdue'], trash_quad: 'NE', sr_type: ['Missed Heavy Trash Pickup','Container Problem','New Resident Container','Recycling Participation NEW' ,'Recycling Cart Repair or Replace','SWM Escalation','Missed Garbage Pickup','Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection', 'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint','Physically Challenged Pickup']).count
    @NEQuadSrOverdue = Sr.where(status:'Open',  expression:'Overdue', trash_quad: 'NE', sr_type: ['Missed Heavy Trash Pickup','Container Problem','New Resident Container','Recycling Participation NEW' ,'Recycling Cart Repair or Replace','SWM Escalation','Missed Garbage Pickup','Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection', 'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint','Physically Challenged Pickup']).count
    @NEQuadPercentOverdue = "#{((@NEQuadSrOverdue.to_f/@NEQuadSrTotal.to_f)*100).round(2)}%"
    @NEQuadSrNotOverdue = Sr.where(status:'Open',  expression:'Not Overdue', trash_quad: 'NE', sr_type: ['Missed Heavy Trash Pickup','Container Problem','New Resident Container','Recycling Participation NEW' ,'Recycling Cart Repair or Replace','SWM Escalation','Missed Garbage Pickup','Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection', 'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint','Physically Challenged Pickup']).count
...
#NORTH WEST
        ...
        @missedRecCarRepNWTotal = Sr.where(trash_quad: 'NW',sr_type:'Recycling Cart Repair or Replace', expression:['Overdue','Not Overdue']).count
        ...
        @missedRecCarRepNWNotOverdue = Sr.where(trash_quad: 'NW',sr_type:'Recycling Cart Repair or Replace', expression:['Not Overdue']).count
        ...
        @missedMisRecPicUpNWTotal = Sr.where(trash_quad: 'NW',sr_type:'Missed Recycling Pickup', expression:['Overdue','Not Overdue']).count
        @missedMisRecPicUpNWOverdue = Sr.where(trash_quad: 'NW',sr_type:'Missed Recycling Pickup', expression:['Overdue']).count
        ...
        @missedMisRecPicUpNWNotOverdue = Sr.where(trash_quad: 'NW',sr_type:'Missed Recycling Pickup', expression:['Not Overdue']).count
        ...
        @NWQuadSrTotal = Sr.where(status:'Open', expression:['Overdue', 'Not Overdue'], trash_quad: 'NW', sr_type: ['Missed Heavy Trash Pickup','Container Problem','New Resident Container','Recycling Participation NEW' ,'Recycling Cart Repair or Replace','SWM Escalation','Missed Garbage Pickup','Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection', 'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint','Physically Challenged Pickup']).count
        @NWQuadSrOverdue = Sr.where(status:'Open',  expression:'Overdue', trash_quad: 'NW', sr_type: ['Missed Heavy Trash Pickup','Container Problem','New Resident Container','Recycling Participation NEW' ,'Recycling Cart Repair or Replace','SWM Escalation','Missed Garbage Pickup','Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection', 'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint','Physically Challenged Pickup']).count
        @NWQuadPercentOverdue = "#{((@NWQuadSrOverdue.to_f/@NWQuadSrTotal.to_f)*100).round(2)}%"
        @NWQuadSrNotOverdue = Sr.where(status:'Open',  expression:'Not Overdue', trash_quad: 'NW', sr_type: ['Missed Heavy Trash Pickup','Container Problem','New Resident Container','Recycling Participation NEW' ,'Recycling Cart Repair or Replace','SWM Escalation','Missed Garbage Pickup','Trash Dumping or Illegal Dumpsite', 'Add A Can', 'Storm Debris Collection', 'Dead Animal Collection', 'Add A Can CANCELLATION', 'Missed Recycling Pickup', 'Personnel or Vehicle Complaint','Physically Challenged Pickup']).count
