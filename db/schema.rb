...
ActiveRecord::Schema.define(version: 2021_07_27_194914) do
  ...
  create_table "cartsrs", force: :cascade do |t|
    t.string "sr_number"
    t.string "client"
    t.string "service_location"
    t.string "status"
  ...
  create_table "route_tons", force: :cascade do |t|
    ...
    t.bigint "route_id"
    t.string "route_name"
    t.integer "RouteData_id"
    t.datetime "RouteDate"
    t.datetime "RouteEntryDate"
    t.string "EmpCenter_id"
    t.integer "RouteNum"
    t.integer "Supervisor_id"
    t.integer "Employee1"
    t.integer "Employee2"
    t.integer "Employee3"
    t.integer "CrewType_id"
    t.integer "VehicleNum"
    t.datetime "LeaveCenter"
    t.integer "LeaveMileage"
    t.datetime "ArriveCenter"
    t.integer "ArriveMileage"
    t.datetime "RouteCompletedTime"
    t.datetime "StartAMBreak"
    t.datetime "EndAMBreak"
    t.datetime "StartPMBreak"
    t.datetime "EndPMBreak"
    t.datetime "StartLunchBreak"
    t.datetime "EndLunchBreak"
    t.string "Comments"
    t.string "LastUpdatedBy"
    t.datetime "LastUpdatedDate"
    t.integer "RouteDataLoad_id"
    t.string "LoadSeq"
    t.datetime "StartLoadTime"
    t.datetime "EndLoadTime"
    t.datetime "ArriveDisposalTime"
    t.datetime "LeaveDisposalTime"
    t.string "DisposalSite"
    t.integer "Tons"
    t.string "WasteType"
    t.string "StartHelpRoute"
    t.string "EndHelpRoute"
    t.string "Help"
    t.string "HelpRoute"
    t.datetime "BackToLoad"
